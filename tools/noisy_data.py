...
def dataset_split(train_images, train_labels, train_paths, noise_rate=0.5, noise_type='symmetric', split_per=0.9, seed=1, num_classes=10):
    '''
    :param train_images: array
    :param train_labels: array
    :param train_paths: array
    :param noise_rate:
    ...
    return train_set, val_set, train_labels, val_labels, train_clean_labels, val_clean_labels, train_absolute_paths, val_absolute_paths
...
def noisify_pairflip(y_train, noise, seed=1, nb_classes=10):
    ...
    if n > 0.0:
        ...
        print('Noisy label transition matrix: ', P)
